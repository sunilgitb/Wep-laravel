...
<head>
    ...
    <title>Our Work Detail - Tech Simians</title>
      ...
      <section class="project" style="margin-top: 80px;">
        <div class="container">
          <h2 class="project__title" style="color:black">Human Resources Management</h2>
          <div class="project__text" style="color:black">
            Human Resources Management System (HRMS) is a versatile software solution that simplifies HR processes for Indian businesses, offering features like attendance tracking, leave management, defining holidays as per the Indian calendar, and more. With an easy-to-use interface and seamless integration, our system allows businesses to switch to the payroll module effortlessly, streamlining salary processing and ensuring compliance with Indian tax regulations. This all-in-one HRMS empowers organizations to efficiently manage their workforce, stay compliant with evolving labor laws, and make data-driven HR decisions, ultimately enhancing overall HR productivity and employee satisfaction.
          </div>
        </div>
        <section class="project__section">

    <section style="margin-top:-50px;">
      <img src="{{asset('frontend/assets/img/desktop-5.png')}}" alt="" width= 100%; height=100%; style="margin-top: 0px;" class="project-1" />
    </section>
...
<body>
  ...
  <section class="">
      ...
      <div class="row container image-row" >
        <div class="col-lg-6">
          <div class="project__grid-item">
            <img src="{{asset('frontend/assets/img/work-9.png')}}" alt="" width= 100%!important; height=100%;  />
          </div>
        </div>
        <div class="col-lg-6">
          <div class="project__grid-item">
            <img src="{{asset('frontend/assets/img/work-10.png')}}" alt="" width= 100%!important; height=100%; />
          </div>
        </div>
      </div>
