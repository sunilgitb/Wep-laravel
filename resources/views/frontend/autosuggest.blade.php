...
<head>
    ...
    <title>@yield('title') {{$post->meta_title}}</title>
        ...
        @endif
            <article class="flex flex-col my-4">
                ...
                <a href="#" class="hover:opacity-75">
                    ...
                    <img src="{{ asset($post->image) }}" alt="Image" class="w-full h-auto">
                </a>
                <div class="bg-white flex flex-col justify-start p-6">
                   ...
                   <p class="project__text_blog"> {!! $post->description !!}</p>
                   <p class="text-blue-700 text-3xl font-bold uppercas">Tags: <strong class="text-base font-light bg-green-100 pl-2 pr-2">{{$post->meta_keywords}}</strong></p>
...
.my-class {
  background-color: #007bff;
      ...
      <div class="container mx-auto px-4 lg:px-8">
        <h3>Related Posts</h3>
        <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pb-5">
          ...
          <div class="bg-white rounded-md shadow-md p-4">
            ...
            <h4 class="mt-2"><a href="{{ route('post.show-single', ['slug' => $post->slug]) }}">{{ \Str::limit($post->title, 20, '...') }}</a></h4>
