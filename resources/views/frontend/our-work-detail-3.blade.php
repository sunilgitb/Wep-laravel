...
<head>
    ...
    <title>Our Work Detail - Tech Simians</title>
      ...
      <section class="project" style="margin-top: 80px;">
        <div class="container">
          <h2 class="project__title" style="color:black">Cash Management System</h2>
          <div class="project__text" style="color:black">
            Cash Management Systems is a robust and secure solution tailored for the efficient management of cross-border payments to agents and vendors. This application excels in meticulously reconciling accounts associated with port costs, all at a nominal fee per port call. Seamlessly integrating with the Diabos application, which is responsible for creating port calls and monitoring the associated payment processing, Cash Management Systems offers a comprehensive solution for the financial aspects of port operations. With this powerful tandem, you can ensure precise and cost-effective financial management, optimizing your port's financial workflows and enhancing transparency in payment processes.
          </div>
        </div>
        <section class="project__section">

    <section style="margin-top:-50px;">
      <img src="{{asset('frontend/assets/img/desktop-3.png')}}" alt="" width= 100%; height=100%; style="margin-top: 0px;" class="project-1" />
    </section>
...
<body>
  ...
  <section class="">
      ...
      <div class="row container image-row" >
        <div class="col-lg-6">
          <div class="project__grid-item">
            <img src="{{asset('frontend/assets/img/work-5.png')}}" alt="" width= 100%!important; height=100%;  />
          </div>
        </div>
        <div class="col-lg-6">
          <div class="project__grid-item">
            <img src="{{asset('frontend/assets/img/work-6.png')}}" alt="" width= 100%!important; height=100%; />
          </div>
        </div>
      </div>
          ...
          <div class="workgrid__row">
            <a href="{{url('our-work-detail-4')}}" class="workgrid__item">
              ...
              <div class="workgrid__item-text">
                The Student Scoop is an educational institution 
              </div>
