...
<head>
    ...
    <title>@yield('title') IT Consulting Services and Solutions in Mumbai | Tech simians </title>
    {{-- <title> Revolutionising Construction Landscape with Advanced Technology Services in mumbai</title>  --}}
        <meta name="description" content="@yield('description', 'Elevate your business with top-notch IT consulting in Mumbai. Comprehensive IT services and consulting solutions for success and growth.')">
        <meta name="keywords" content="@yield('keywords', 'it consulting in mumbai, it consulting, it services and consulting')">
