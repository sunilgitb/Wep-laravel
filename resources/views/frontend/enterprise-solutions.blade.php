...
<head>
    ...
    <title>@yield('title') Empower Your Business with Top-Tier Enterprise Solutions</title>
    {{-- <title> Revolutionising Construction Landscape with Advanced Technology Services in mumbai</title>  --}}
        <meta name="description" content="@yield('description', 'Elevate your business with top-tier enterprise resource management software. Explore comprehensive solutions for seamless enterprise planning and success.')">
        <meta name="keywords" content="@yield('keywords', 'enterprise resource management software, enterprise planning software')">
