...
<head>
    ...
    <title>Our Work Detail - Tech Simians</title>
      ...
      <section class="project" style="margin-top: 80px;">
        <div class="container">
          <h2 class="project__title" style="color:black">TripDarwin</h2>
          <div class="project__text" style="color:black">
            Tripdarwin is a comprehensive platform designed to cater to all your travel needs. This all-in-one travel solution simplifies your journey by offering a range of services, including hotel bookings, transportation options, activities, meal planning, access to guides, and rail passes. With a global reach, Tripdarwin makes travel hassle-free and convenient in various destinations around the world, such as Germany, Finland, Greece, Italy, and more. Whether you're planning a business trip, a romantic getaway, or a family vacation, Tripdarwin aims to streamline and enhance your travel experience.
          </div>
        </div>
        <section class="project__section">

    <section style="margin-top:-50px;">
      <img src="{{asset('frontend/assets/img/desktop-2.png')}}" alt="" width= 100%; height=100%; style="margin-top: 0px;" class="project-1" />
    </section>
...
<body>
  ...
  <section class="">
      ...
      <div class="row container image-row" >
        <div class="col-lg-6">
          <div class="project__grid-item">
            <img src="{{asset('frontend/assets/img/work-3.png')}}" alt="" width= 100%!important; height=100%;  />
          </div>
        </div>
        <div class="col-lg-6">
          <div class="project__grid-item">
            <img src="{{asset('frontend/assets/img/work-4.png')}}" alt="" width= 100%!important; height=100%; />
          </div>
        </div>
      </div>
          ...
          <div class="workgrid__row">
            <a href="{{url('our-work-detail-3')}}" class="workgrid__item">
              ...
              <div class="workgrid__item-text">
                Cash Management Systems is a robust and secure solution
              </div>
