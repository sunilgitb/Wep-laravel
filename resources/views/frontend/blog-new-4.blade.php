...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Blog Post html css</title>
  ...
  <div class="wrapper">
    <div class="card">
      <div class="card-banner">
        ...
        <img class="banner-img" src='https://dev-to-uploads.s3.amazonaws.com/uploads/articles/xna5h3bfbgmyrb6py1o7.jpg' alt=''>
      </div>
      <div class="card-body">
        <p class="blog-hashtag">Admin</p>
        <h2 class="blog-title"><a href="#">What is the tastiest pizza in Pizza Hut?</a></h2>
    ...
    <div class="card">
      <div class="card-banner">
        ...
        <img class="banner-img" src='https://dev-to-uploads.s3.amazonaws.com/uploads/articles/lr627qqql65d9hvr5nsq.jpg' alt=''>
      </div>
      <div class="card-body">
        <p class="blog-hashtag">Admin</p>
        <h2 class="blog-title"><a href="#">Which city is famous for biryani in India?</a></h2>
    ...
    <div class="card">
      <div class="card-banner">
        ...
        <img class="banner-img" src='https://dev-to-uploads.s3.amazonaws.com/uploads/articles/nfz3z2osldbm8ymanmoq.jpg' alt=''>
      </div>
      <div class="card-body">
        <p class="blog-hashtag">Admin</p>
