...
<div class="card">
  ...
  <div class="text-right">
            @can('Post create')
              <a href="{{route('admin.tags.create')}}" class="bg-blue-500 text-blue font-bold px-5 py-1 rounded focus:outline-none shadow hover:bg-blue-500 transition-colors ">New Tag</a>
            @endcan
          </div>
  @if(session('success'))
          ...
          <tr>
            ...
            {{-- <td class="py-4 px-6 border-b border-grey-light">
                  ...
                  <td class="py-4 px-6 border-b border-grey-light text-right">
                    ...
                    @can('Tag edit')
                    <a href="{{route('admin.tags.edit',$tag->id)}}" class="btn btn-info" style="margin-right: 150px;">Edit</a>
                    @endcan
