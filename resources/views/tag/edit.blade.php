              ...
              <div class="bg-white shadow-md rounded my-6 p-5">
                <form method="POST" action="{{ route('admin.tags.update',$tag->id)}}">
                  ...
                  <div class="flex flex-col space-y-2">
                    ...
                    <input id="title" type="text" name="title" value="{{ old('title',$tag->tag_name) }}"
              ...
              <form method="POST" action="{{ route('admin.tags.update',$tag->id)}}">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="tag_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Title" value="{{ old('tag_name',$tag->tag_name) }}">
                  </div>
