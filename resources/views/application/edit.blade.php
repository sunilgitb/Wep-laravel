              ...
              <div class="bg-white shadow-md rounded my-6 p-5">
                <form method="POST" action="{{ route('admin.applications.update',$application->id)}}">
                  ...
                  <div class="flex flex-col space-y-2">
                    ...
                    <input id="title" type="text" name="name" value="{{ old('name',$application->name) }}"
                  ...
                  <div class="flex flex-col space-y-2">
                    ...
                    <input id="title" type="text" name="email" value="{{ old('email',$application->email) }}"
                ...
                <div class="grid grid-cols-3 gap-4">
                  <div class="relative inline-flex">
                    ...
                    <select class="border border-gray-300 rounded-full text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none" name="publish">
                      ...
                      <option value="1" @if($application->publish) selected @endif>Publish</option>
                    </select>
                  </div>
                </div>
